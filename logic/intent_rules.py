...
INTENT_RULES = [
    {"keywords": ["xin chào", "chào", "hello", "hi", "shop ơi", "có ai không", "lô", "hế nhô", "chao xìn", "hi shop", "có đó không shop ơi", "bấy bề", "ê"], "intent": "greeting"},
    ...
    {"keywords": ["feedback", "đánh giá", "nhận xét", "phản hồi", "review", "ngon", "dở", "tệ", "không ngon", "không thích", "ghét", "dị ứng"], "intent": "ask_feedback"},
    ...
    {"keywords": ["bảo quản", "giữ lạnh", "để được bao lâu", "hạn sử dụng", "shelf life", "bảo quản bánh", "giữ bánh", "để bánh"], "intent": "ask_preservation"},
